    ...
    <div>
      ...
      <div className="bg-Color5">
        <div className="flex flex-col items-center justify-center pt-[6rem]">
          <h3 className="text-[3rem] mb-24 font-semibold">Why To Join Us?</h3>
          <ul className="flex flex-wrap justify-around w-[100vw] max-w-[80rem] items-start">
            <li className="w-[11rem] flex flex-col justify-center items-start">
